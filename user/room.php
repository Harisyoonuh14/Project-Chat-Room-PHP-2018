		...
		<div class="col-lg-8">
            <div class="panel panel-default" style="height:50px;">
				<span style="font-size:20px; margin-left:10px; position:relative; top:13px;"><strong><span  id="user_details"><span class="glyphicon glyphicon-user"></span><span class="badge"><?php echo mysqli_num_rows($cmem); ?></span></span> <?php echo $chatrow['chat_name']; ?></strong></span>
				...
				<div class="pull-right" style="margin-right:10px; margin-top:7px;">
					<?php
						if ($chatrow['userid']==$_SESSION['id']){
							...
							<a href="#add_member" data-toggle="modal" class="btn btn-info">Add Member</a>
							<a href="#kick_member" data-toggle="modal" class="btn btn-warning">Kick Member</a>
							<?php
						}
						else{
							?>
			...
			<div>
				<div class="panel panel-default" style="height: 400px;">
					<div style="height:10px;"></div>
					<span style="font-size:25px; margin-left:10px;">Welcome to Chatroom</span><br>
					<div style="height:10px;"></div>
